...
const Process = () => {
  return (
    <section className="text-white w-full flex justify-center md:pt-32 pt-18 mb-30">
      <div className="md:w-7/12 w-9/12 flex flex-col items-center gap-6">
        {/* process button */}
        {/* <div className="process- w-32 rounded-full py-2"/> */}
        <div className="bg-[#0a0720] ring ring-blue-400 py-1 px-4 rounded-2xl ring-offset-2 ring-offset-blue-600 text-center w-28">Process</div>
        {/* heading */}
